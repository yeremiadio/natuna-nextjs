...
function DeleteCategoryModal({ parent, id, name, mutate, category, toast }) {
  ...
  const deleteCategory = useCallback(async () => {
    ...
    instance()
      ...
      .then((res) => {
        ...
        mutate([...category.filter((item) => item.id !== id)], false);
      })
      .catch((err) => {
        toast({
          title: "Error",
      ...
      <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4 sm:flex sm:items-start">
        ...
        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
          ...
          <p className="text-sm text-secondary">
            Are you sure you want to delete this category? This category name{" "}
